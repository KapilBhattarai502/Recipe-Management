  ...
  return (
    <div>
           ...
           <h3 className="font-bold text-xl">User:Kapil Bhattarai</h3>
            <div className="flex justify-between items-center bg-slate-700 p-3 cursor-pointer">
            ...
            <div className="mt-2">
              ...
              <div className="flex justify-between items-center bg-slate-700 p-3 mt-2 cursor-pointer">
